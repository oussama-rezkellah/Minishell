...
/*   Updated: 2024/08/27 07:00:07 by orezkell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_empty(t_env **new_env)
{
	...
	*new_env = NULL;
	pwd = NULL;
	lst_addback_env(new_env, lstnew_env(ft_strdup_env("/usr/gnu/bin:/usr/local/bin:/bin:/usr/bin:."), ft_strdup_env("PATH"), ft_strdup_env("PATH=/usr/gnu/bin:/usr/local/bin:/bin:/usr/bin:.")));
	...
	lst_addback_env(new_env, lstnew_env(NULL, ft_strdup_env("OLDPWD"), ft_strdup_env("OLDPWD=")));
	ft_malloc(1, CLEAR);
}
