...
utils/build_tree/build_tree_utils.c utils/build_tree/shunting_utils.c utils/env/env.c utils/env/ft_strdup_env.c \
utils/env/lst_addback_env.c utils/env/lst_array.c utils/env/lstnew_env.c utils/env/lstsize_env.c utils/env/shlvl.c utils/env/env_set_get.c utils/ft_atoi.c \
utils/ft_isspace.c utils/ft_itoa.c utils/ft_strchr.c utils/ft_strdup.c utils/ft_strjoin.c utils/ft_strlcpy.c \
