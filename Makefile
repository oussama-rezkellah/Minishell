...
utils/exit_status.c execution/handle_heredoc.c execution/builtins/export.c execution/builtins/echo.c execution/builtins/pwd.c \
execution/builtins/cd.c execution/builtins/env.c
